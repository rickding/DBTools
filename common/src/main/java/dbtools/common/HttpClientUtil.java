...
public class HttpClientUtil {
    ...
    private static String sendHttpPost(HttpPost httpPost) {
        ...
        try {
            ...
            if (true || HttpStatus.SC_OK == response.getStatusLine().getStatusCode()) {
    ...
    private static String sendHttpDelete(HttpDelete httpDelete) {
        ...
        try {
            ...
            System.out.printf("Error when call delete: %s, %s\r\n", httpDelete.getURI().toString(), e.getMessage());
        } finally {
            try {
                if (response != null) {
                    response.close();
     ...
     */
    public static String sendHttpPostJson(String httpUrl, Map<String, String> headers, String paramsJson) {
        HttpPost httpPost = new HttpPost(httpUrl);// 创建httpPost
